...
Updates the Proposal status to <var>processing</var>, and triggers async Campaign generation, once completed its status will be <var>converted</var>. Target proposal must be in <var>ready</var> or <var>failed</var> status.
